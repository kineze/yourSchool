      ...
      <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 lg:w-7/12 xl:w-8/12">
        <div class="flex flex-wrap -mx-3">
          <div class="w-full max-w-full px-3 sm:flex-0 shrink-0 sm:w-4/12">
            <div class="border-black/12.5 shadow-soft-xl dark:bg-gray-950 dark:shadow-soft-dark-xl relative flex min-w-0 flex-col overflow-hidden break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
              <div class="p-4 pb-0 rounded-t-2xl">
                <p class="mb-0 font-semibold leading-normal capitalize text-sm dark:text-white dark:opacity-60">Visitors</p>
                <h5 class="mb-0 font-bold dark:text-white">
                  5,927
                  <span class="font-bold leading-normal text-sm text-lime-500">+55%</span>
                </h5>
              </div>
          ...
          <div class="w-full max-w-full px-3 mt-6 sm:flex-0 shrink-0 sm:mt-0 sm:w-4/12">
            <div class="border-black/12.5 shadow-soft-xl dark:bg-gray-950 dark:shadow-soft-dark-xl relative flex min-w-0 flex-col overflow-hidden break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
              <div class="p-4 pb-0 rounded-t-2xl">
                <p class="mb-0 font-semibold leading-normal capitalize text-sm dark:text-white dark:opacity-60">Income</p>
                <h5 class="mb-0 font-bold dark:text-white">
                  $130,832
                  <span class="font-bold leading-normal text-sm text-lime-500">+90%</span>
                </h5>
              </div>
              <div class="flex-auto p-0">
                <div>
          ...
          <div class="w-full max-w-full px-3 mt-6 sm:flex-0 shrink-0 sm:mt-0 sm:w-4/12">
            <div class="relative flex flex-col h-full min-w-0 break-words bg-white border border-solid dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl border-slate-100 bg-clip-border dark:border-slate-700">
              <div class="flex flex-col justify-center flex-auto p-6 text-center">
                <a href="javascript:;">
                  <i class="mb-1 leading-normal fa fa-plus text-sm text-slate-400 dark:text-white dark:opacity-80"> </i>
                  <h6 class="text-slate-400 dark:text-white dark:opacity-80">New tab</h6>
                </a>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap -mx-3">
          <div class="w-full max-w-full px-3 sm:flex-0 shrink-0 sm:w-4/12 lg:w-full">
            <div class="border-black/12.5 shadow-soft-xl dark:bg-gray-950 dark:shadow-soft-dark-xl relative flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
              <div class="relative h-full overflow-hidden rounded-xl bg-[url('../../assets/img/ivancik.jpg')] bg-cover">
                <span class="absolute top-0 left-0 w-full h-full bg-center bg-cover bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 opacity-80"></span>
                <div class="relative z-10 flex-auto h-full p-4">
                  <h6 class="mb-4 font-bold text-white">Hey John!</h6>
                ...
                <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                  <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
                    <div class="flex items-center">
                      ...
                      <div class="flex flex-col">
                        ...
                        <span class="leading-tight text-xs">250 in stock, <span class="font-semibold">346+ sold</span></span>
                      </div>
                    </div>
                    <div class="flex">
                  ...
                  <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-xl text-inherit">
                    <div class="flex items-center">
                      ...
                      <div class="flex flex-col">
                        ...
                        <span class="leading-tight text-xs">123 closed, <span class="font-semibold">15 open</span></span>
                      </div>
                    </div>
                    <div class="flex">
                      <button class="group ease-soft-in leading-pro text-xs rounded-3.5xl p-1.2 h-6 w-6 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i class="ni leading-none ease-bounce text-3xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
                  ...
                  <li class="relative flex justify-between py-2 pr-4 border-0 rounded-b-lg rounded-xl text-inherit">
                    <div class="flex items-center">
                      ...
                      <div class="flex flex-col">
                        <h6 class="mb-1 leading-normal text-sm text-slate-700 dark:text-white">Error logs</h6>
                        <span class="leading-tight text-xs">1 is active, <span class="font-semibold">40 closed</span></span>
                      </div>
                    </div>
                    <div class="flex">
                      <button class="group ease-soft-in leading-pro text-xs rounded-3.5xl p-1.2 h-6 w-6 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i class="ni leading-none ease-bounce text-3xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
          ...
          <div class="p-4 pb-0 rounded-t-2xl">
            <div class="flex flex-wrap -mx-3">
              <div class="w-full max-w-full px-3 md:flex-0 shrink-0 md:w-6/12">
                <h6 class="mb-0 dark:text-white">Transactions</h6>
              </div>
      ...
      <div class="w-full max-w-full px-3 mt-6 sm:flex-0 shrink-0 sm:mt-0 sm:w-6/12">
        <div class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-2xl border-slate-100 bg-clip-border dark:border-slate-700">
          <div class="p-4 pb-0 rounded-t-2xl">
            <div class="flex flex-wrap -mx-3">
              <div class="w-full max-w-full px-3 md:flex-0 shrink-0 md:w-6/12">
                <h6 class="mb-0 dark:text-white">Revenue</h6>
              </div>
              <div class="flex items-center justify-end w-full max-w-full px-3 md:flex-0 shrink-0 md:w-6/12">
                <i class="mr-2 far fa-calendar-alt"></i>
